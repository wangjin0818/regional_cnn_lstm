...
if __name__ == '__main__':
    ...
    embedded_sequences = Embedding(input_dim=max_features, output_dim=num_features, input_length=max_l, mask_zero=True, weights=[W], trainable=False) (sentence_input)
    l_lstm = Bidirectional(LSTM(hidden_dim))(embedded_sequences)
